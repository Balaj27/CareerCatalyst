...
export default function DashboardPage() {
  ...
  return (
    <Box sx={{ display: 'flex', }}>
      ...
      <Box
        component="main"
        sx={{ flexGrow: 1, bgcolor: '#f5f5f5', p: 3, ml: `0px` }}
      >
        <Toolbar />
          ...
          <Grid item xs={12} sm={6} md={3} key={i}>
            <Card sx={{ bgcolor: '#fff', color: '#000', boxShadow: 3 }}>
              <CardContent>
                ...
                <Typography variant="body2" color="green">{stat.change}</Typography>
              </CardContent>
            </Card>
          </Grid>
        ))}
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} md={6}>
          <Card sx={{ bgcolor: '#fff', boxShadow: 3 }}>
            <CardContent>
              <Typography variant="h6" gutterBottom>Courses Completed (Last 30 days)</Typography>
        ...
        <Grid item xs={12} md={6}>
          <Card sx={{ bgcolor: '#fff', boxShadow: 3 }}>
            <CardContent>
              <Typography variant="h6" gutterBottom>Jobs Applied (Last 6 months)</Typography>
              <ResponsiveContainer width="100%" height={250}>
        ...
        <Grid item xs={12} md={6}>
          <Card sx={{ bgcolor: '#fff', boxShadow: 3 }}>
            <CardContent>
              <Typography variant="h6" gutterBottom>Interviews Completed</Typography>
              <ResponsiveContainer width="100%" height={250}>
        ...
        <Grid item xs={12} md={6}>
          <Card sx={{ bgcolor: '#fff', boxShadow: 3 }}>
            <CardContent>
              <Typography variant="h6" gutterBottom>Mock Test Score Average</Typography>
              <ResponsiveContainer width="100%" height={250}>
